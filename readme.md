...
следующим образом: `Get-Module 'ITG.Readme';`.
...
`ITG.Readme`. Для чего? И вот для чего: `Get-Help about_ITG.Readme` или
`Get-Module 'ITG.Readme' | Get-Help` выдаст содержимое созданного `about_ITG.Readme.txt` файла
...
`Get-Module 'ITG.Readme' | [Set-HelpXML][] -Cab -PassThru | [Set-HelpInfo][];`.
...
`Get-Module 'ITG.Readme' | [Set-HelpXML][] -Cab -UpdateModule | [Set-HelpInfo][] -UpdateManifest;`
